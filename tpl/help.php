<!DOCTYPE html> <html>   <head>     <title>广告位市场  - 用户使用帮助</title>     <meta
          ...
          <div class="content">
              ...
              <div class="tabbable"> <!-- Only required for left/right tabs -->
                <ul class="nav nav-tabs" style="padding-left:30%;">
                  ...
                  <li id="question-tab">
                    <a href="#question-content"  data-toggle="tab">
                ...
                <div class="tab-content">
                  ...
                  <!--question content-->
                   <div class="tab-pane " id="question-content">
                    <h5>1、如何返回首页？</h5>
                    <p>点击本站LOGO即可快速返回网站首页</p>
                    <h5>2、在哪里充值和提现？</h5>
                    <p>用户的充值和提现操作都在财务中心</p>
                    <h5>3、怎么切换为买家和卖家？</h5>
                    <p>在用户中心点击顶部导航栏的按钮即可在买家和卖家页面之间相互切换。</p>
                    <h5>4、提现时间大概需要多久？</h5>
                    <p>支付宝提现一般在一个工作日内即可完成，而申请银联卡方式提现一般需要1-3个工作日</p>
                    <h5>5、忘记登录密码了怎么办？</h5>
                    <p>在登录页面中点击忘记密码，即可跳转到找回密码页面，输入邮箱后点击找回密码，系统会自动发送随机的密码到您的邮箱，使用此新密码即可登录后设置您的密码。</p>
                    <h5>6、为什么账户的钱扣了，但是提现钱款却还没有到账？</h5>
