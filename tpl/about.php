  ...
  <body>
    ...
    <div class="section" align="center">
      <div class="container box std-container" align="left" style="padding:20px 40px;">
          ...
          <div class="content">
              <p class="p">
                广告位市场是北京九尾狐科技有限公司于2013年7月创办，在短短的几个月时间里，以其优质的广告及完善的服务，已经与多个知名网站站长建立长久合作关系，并且也与数百家广告主建立信任关系，并且每天以几十家网站的速度发展。
              </p>

             <p>
              广告位市场是国内领先的网络广告营销平台，利用完全自主研发的网络广告系统、效果监测评估系统、广告位交易系统、收益对比分析系统，以及精准广告投放系统，融合现有国内传统营销模式，兼并国外创新理念，以雄厚的资金，高素质的研发团队，先进的互联网技术，前沿的用户体验设计，规范的公司管理机制，为千千万万网络公司和传统企业广告主打造一个定时、定量、定区域、定行业的自由广告市场。
            </p>
            <p>
